...
df_output = pd.DataFrame(Data_f,
    columns=[
        "DSPT status",
        "No. of GP practices that are compliant with (meet or exceed) the 20/21 DSPT standard ",
        "Total number of Practices",
        "Percent of GP practices that are compliant with (meet or exceed) the 20/21 DSPT standard ",
        "Date",
    ],
)
