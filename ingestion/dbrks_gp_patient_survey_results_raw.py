...
if date not in historical_dataframe["Date"].values:
  historical_dataset = historical_dataset.append(new_dataframe)
  historical_dataset = historical_dataset.reset_index(drop=True)
  historical_dataset.index.name = "Unique ID"
else:
